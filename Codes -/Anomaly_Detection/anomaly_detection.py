...
while True:
        ...
        try:
           ...
           print("There was an error while prasing the response: ",e)
           continue

        bound = compute_bounds(history_data,conf.FRAME_SIZE,conf.MUL_FACTOR)
        if not bound:
           required_data_count=conf.FRAME_SIZE-len(history_data)
           print("Not enough datato compute Z-score. Need ",required_data_count,"more data points")
        ...
        try:
           if sensor_value > bound[0] :
             ...
             response = sms.send_sms("Someone turned on the lights")
              ...
              print("This is theresponse ",response)
